...
int MyTest::SanityCheck(
	...
	vector<PairRecord*>& priorityQueue, unordered_map<long,
	unordered_map<long, PairTracker >> &activePairs)
{
...
int MyTest::SanityCheckPairRecords(vector<SymbolRecord*> & sequenceArray, vector<PairRecord*>& priorityQueue, unordered_map<long, unordered_map<long, PairTracker>>& activePairs)
{
	bool sane = true;
	int result = 0;
	SymbolRecord* sr;
	...
	sane = true;
	//Check active pairs
	unordered_map<long, unordered_map<long, PairTracker>>::iterator iterone;
	unordered_map<long, PairTracker>::iterator itertwo;
...
void MyTest::ActivePairs(string msg, unordered_map<long, unordered_map<long, PairTracker>>& activePairs)
{
	cout << msg << ": ";
