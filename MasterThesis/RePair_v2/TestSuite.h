...
public:
	...
	long terminalIndicesWords = 2 * 1;
	long rootsWords = 2 * 1;
	long symbolToGenWords = 2 * 1;
	long pairVectorsOuterWords = 2 * 1;
	long pairVectorsInnerWords = 2 * 1;
	long offsetWords = 2 * 1;
	long dictionaryWords = 2 * 3;
	long namedPairWords = 2 * 4;
	long indicesWords = 2 * 2 * 1;
	...
	long m_repair_dictionary_max = 0;
	long m_repair_terminals_max = 0;
	...
	long m_huffEnc_dictionary_max = 0;
	...
	long m_huffEnc_terminals_max = 0;
	...
	long m_norDic_dictionary_max = 0;
