...
//	pq.pop();
//	
//	h.unravel(leftChild, rightChild);
//	ASSERT_EQ("000", frequencies[(unsigned int)'.']->code);
//	ASSERT_EQ("001", frequencies[(unsigned int)'o']->code);
//	ASSERT_EQ("0100", frequencies[(unsigned int)'E']->code);
//	ASSERT_EQ("0101", frequencies[(unsigned int)'a']->code);
//	ASSERT_EQ("0110", frequencies[(unsigned int)'m']->code);
//	ASSERT_EQ("0111", frequencies[(unsigned int)'u']->code);
//	ASSERT_EQ("1000", frequencies[(unsigned int)'s']->code);
//	ASSERT_EQ("1001", frequencies[(unsigned int)'w']->code);
//	ASSERT_EQ("101", frequencies[(unsigned int)'H']->code);
//	ASSERT_EQ("1100", frequencies[(unsigned int)'h']->code);
//	ASSERT_EQ("1101", frequencies[(unsigned int)'A']->code);
